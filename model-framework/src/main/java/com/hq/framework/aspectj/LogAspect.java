package com.hq.framework.aspectj;

import java.lang.reflect.Method;
import java.util.Map;

import com.hq.common.annotation.Log;
import com.hq.common.enums.BusinessStatus;
import com.hq.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.hq.common.annotation.Log)")
